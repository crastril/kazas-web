...
import { CheckCircle2, ChevronRight, ChevronLeft, MapPin, Home, User, DollarSign } from "lucide-react";
            ...
            <form action={formAction} className="bg-card p-8 rounded-xl border shadow-lg space-y-6">
                ...
                {step === 0 && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                        <div className="space-y-2">
                            <Label htmlFor="propertyAddress">Adresse de la Propriété / Localisation</Label>
                            <Input name="propertyAddress" placeholder="ex: Anses-d'Arlet, Martinique" required />
                            <p className="text-xs text-muted-foreground">Une localisation approximative suffit pour l'estimation.</p>
                        </div>
                    </div>
                )}
                ...
                {step === 1 && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="currentRevenue">Revenu Annuel Actuel (Optionnel)</Label>
                            <Input name="currentRevenue" placeholder="ex: 40 000 €" />
                        </div>
                    </div>
                )}
                ...
                {step === 2 && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input name="ownerEmail" type="email" placeholder="jean@exemple.com" required />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="ownerPhone">Téléphone (Optionnel)</Label>
                ...
                <div className="flex justify-between pt-4 border-t">
                    ...
                    {step < steps.length - 1 ? (
                        ...
                        <Button type="submit" disabled={isPending} className="min-w-[140px]">
                            {isPending ? "Analyse en cours..." : "Obtenir mon Audit"}
                        </Button>
                    )}
                </div>
